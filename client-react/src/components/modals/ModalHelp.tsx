        ...
        <ModalWrapper title="Guida e contatti MixTo" onRequestClose={props.onClose}>
            <div className="text-center">
                ...
                {!mostraGuida &&
                    <>
                        <h1>Contatti</h1>
                        <img onError={defaultArtistaPicture} width={180} height={180} className="rounded-full shadow-lg" src="src/assets/stefano_di_bisceglie.png" alt="Stefano Di Bisceglie. sviluppatore di MixTo" />
