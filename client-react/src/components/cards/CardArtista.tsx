...
function CardArtista(props: { artista: ArtistaDb }) {
    ...
    return (
        <div onClick={() => {navigate("/artista?id=" + props.artista.id);}} style={{ border: "1px solid black", borderRadius: "8px", padding: "10px", margin: "10px", cursor: "pointer" }}>
            <img style={{ width: "100px", height: "100px", borderRadius: "50%" }} src={props.artista.url_immagine ? props.artista.url_immagine : "src/assets/artista_empty.jpg"} alt={"Immagine di profilo di " + props.artista.nome} />
