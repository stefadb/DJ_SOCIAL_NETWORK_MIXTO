...
import { deezerColor, genereEmptyPictureUrl, scaleTwProps} from "../../functions/functions";
        ...
        <>
            <div onClick={() => { navigate("/genere?id=" + props.genere.id); }} ref={containerRef} style={scaleTwProps("p-3 cursor-pointer opacity-0 transition-opacity duration-500 w-[100px]",scale)}>
                <div className="relative">
                    ...
                    <img  style={scaleTwProps("w-[100px] h-[100px] shadow-md"/*no custom*/,scale)} src={props.genere.url_immagine ? props.genere.url_immagine : genereEmptyPictureUrl()} alt={"Immagine del genere musicale " + props.genere.nome} />
                </div>
