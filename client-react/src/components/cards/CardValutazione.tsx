import type { DigitDotDigit, ValutazioneEUtente } from "../../types/types";
    ...
    return (
        <div style={{ border: "1px solid #ccc", borderRadius: 8, padding: 16, marginBottom: 16 }}>
            <div style={{ display: "flex", alignItems: "center", marginBottom: 8 }}>
                ...
                <span style={{ marginLeft: 8 }}><Stelle rating={String(valutazione.voto).substring(0, 1) + ".0" as DigitDotDigit} /></span>
            </div>
        </div>
    );
}
