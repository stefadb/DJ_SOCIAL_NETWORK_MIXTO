    ...
    return (
        <div ref={containerRef} onClick={() => { navigate("/utente?id=" + props.utente.id); }} style={scaleTwProps("p-3 cursor-pointer opacity-0 transition-opacity duration-500 w-[100px]",scale)}>
            <div className="relative">
                ...
                <img  style={scaleTwProps("w-[100px] h-[100px] rounded-full shadow-md"/*no custom*/,scale)} src={artistaEmptyPictureUrl()} alt={"Immagine di profilo di " + props.utente.nome + " " + props.utente.cognome} />
            </div>
