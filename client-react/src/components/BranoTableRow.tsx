...
function BranoTableRow(props: { element: { numero_passaggi: number; id_brano_1: number; brano_1_array: BranoDb[] } | { numero_passaggi: number; id_brano_2: number; brano_2_array: BranoDb[] } }) {
    ...
    return <div className="classifica-row">
        <div className="classifica-cell" style={{cursor: "pointer"}} onClick={navigateToBrano}><div className="classifica-cell-inside">{props.element.numero_passaggi}</div></div>
        <div className="classifica-cell" style={{cursor: "pointer"}} onClick={navigateToBrano}><div className="classifica-cell-inside">{"brano_1_array" in props.element ? props.element.brano_1_array[0].titolo : props.element.brano_2_array[0].titolo}</div></div>
        <div className="classifica-cell" style={{cursor: "pointer"}} onClick={navigateToBrano}><div className="classifica-cell-inside">{"brano_1_array" in props.element ? props.element.brano_1_array[0].durata : props.element.brano_2_array[0].durata}</div></div>
