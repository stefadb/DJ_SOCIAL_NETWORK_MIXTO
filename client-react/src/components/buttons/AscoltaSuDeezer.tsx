...
function AscoltaSuDeezer(props: { id: number, entity: "track" | "album", scale: number}) {
    ...
    <button id={randomId} onClick={() => { window.open(`https://www.deezer.com/${props.entity}/${props.id}`, "_blank"); }} className={"card-button"} style={scaleTwProps("pt-2 pr-1 pb-2 pl-1 rounded", props.scale)}>
