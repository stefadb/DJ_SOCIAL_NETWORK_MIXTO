...
exports.DeezerResponseMultipleItemsSchema = exports.DeezerResponseSingleItemSchema = exports.GenereDbSchema = exports.AlbumDbSchema = exports.BranoDbSchema = exports.ArtistaDbSchema = exports.GenereDeezerBasicSchema = exports.ArtistaDeezerBasicSchema = void 0;
...
exports.AlbumDbSchema = zod_1.z.object({
    id: zod_1.z.number(),
    titolo: zod_1.z.string(),
    data_uscita: zod_1.z.string(),
    id_genere: zod_1.z.number()
});
...
exports.DeezerResponseSingleItemSchema = zod_1.z.object({
    id: zod_1.z.number(),
    picture_big: zod_1.z.string(),
});
