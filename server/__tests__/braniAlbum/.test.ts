...
import expectedDbUpsertResult from "./expected_db_upsert_result.json";
...
commonDeezerGetTestSuite(testConfig, mockDeezerResponseRaw, expectedApiSuccessResponse, expectedDbUpsertResult, mockedAxios);